...
class Menu:
        ...
        while True:
            ...
            for event in pg.event.get():
                ...
                if not hasattr(self.game, 'map'):
                    if self.game.player:
                        if self.player1.draw(self.screen):
                            self.game.player = False
                    else:
                        if self.player2.draw(self.screen):
                            self.game.player = True
                else:
                    if self.game.player:
                ...
                if not hasattr(self.game, 'map'):
                    draw_text(self.screen, str(self.game.mapsize), 50, (255, 255, 255), \
                              (self.width / 2 + 0.5 * self.mapsize_img.get_width() + self.plus_img.get_width(),
                               self.height * 0.375))
    ...
    def load_images(self):
        ...
        player2_img = pg.image.load('assets/menu/Player2.png').convert_alpha()
        player1_img = pg.image.load('assets/menu/Player1.png').convert_alpha()
        ...
        self.cheatsoff_button = Button((self.width - cheatsoff_img.get_width()) / 2, self.height * 0.2, cheatsoff_img,
                                       1)
        self.mapsize_button = Button((self.width - self.mapsize_img.get_width() - self.plus_img.get_width()) / 2,
                                     self.height * 0.35, self.mapsize_img, 1)
        self.plus_button = Button(self.width / 2 + 0.5 * self.mapsize_img.get_width(), self.height * 0.35,
                                  self.plus_img, 1)
        self.minus_button = Button(self.width / 2 + 0.5 * self.mapsize_img.get_width(), self.height * 0.40, minus_img,
                                   1)
        ...
        self.player1 = Button((self.width - player1_img.get_width()) - 200, self.height * 0.2, player1_img, 1)
        self.player2 = Button((self.width - player2_img.get_width()) - 200, self.height * 0.2, player2_img,
                              1)
